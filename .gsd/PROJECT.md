...
**Content sources:**
- `.gsd/sources/CONSOLIDATED.md` — master synthesis of all inputs
- `.gsd/sources/notes/` — authoritative planning docs and specs
- `.gsd/sources/references/` — company documents, handbook excerpts
- `.gsd/sources/student-project/` — ideas-only, UNLICENSED code
- `.gsd/sources/old-site/` — original frameset website content
...
- **Copyright**: No reuse of flagged student-project assets. All images must be owner-supplied or AI-generated. See `.gsd/sources/student-project/COPYRIGHT-FLAGS.md`.
