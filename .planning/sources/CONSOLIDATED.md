...
| notes | planning docs | Authoritative | .planning/sources/notes/ |
| references | company docs | Baseline | .planning/sources/references/ |
| student-project | prior implementation | Ideas-only | .planning/sources/student-project/ |
| old-site | original website | Baseline | .planning/sources/old-site/ |
...
⚠️ **Copyright-restricted items excluded.** See .planning/sources/student-project/COPYRIGHT-FLAGS.md for full audit (3 HIGH, 3 MEDIUM risk items).
