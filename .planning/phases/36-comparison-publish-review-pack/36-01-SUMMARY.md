...
3. **Task 3: Write owner-facing instructions and forward-boundary closeout** - `b16f0f8` (docs)
...
- `site/epic/index.html`: FOUND
- `36-OWNER-INSTRUCTIONS.md`: FOUND
- `36-01-SUMMARY.md`: FOUND
- Commit `22d28fa`: FOUND
- Commit `d2b0ef9`: FOUND
- Commit `b16f0f8`: FOUND
- Commit `f5b9ac2`: FOUND
